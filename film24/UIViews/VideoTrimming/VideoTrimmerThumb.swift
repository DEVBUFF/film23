...
class VideoTrimmerThumb: UIView {
	...
	var leadingChevronImageView = UIImageView(image: UIImage(named: "trim_left"))
	var trailingChevronView = UIImageView(image: UIImage(named: "trim_right"))
...
//		let chevronFrame = CGRect(x: chevronHorizontalInset, y: chevronVerticalInset, width: chevronWidth - chevronHorizontalInset * 2, height: size.height - chevronVerticalInset * 2)
        ...
        leadingChevronImageView.frame = leadingView.bounds
        trailingChevronView.frame = trailingView.bounds
